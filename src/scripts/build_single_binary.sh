...
elif [ -f "/Users/hannes/Private/kiji-proxy/.venv/lib/python3.13/site-packages/onnxruntime/capi/$ONNX_LIB_NAME" ]; then
    # Fallback to hardcoded path (for backwards compatibility)
    ONNX_LIB_PATH="/Users/hannes/Private/kiji-proxy/.venv/lib/python3.13/site-packages/onnxruntime/capi/$ONNX_LIB_NAME"
elif [ -d ".venv" ]; then
    # Try to find in .venv
